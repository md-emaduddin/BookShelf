                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            @if($row->status == 'pending')
                                <a class="btn btn-xs btn-flat btn-warning" onclick="return confirm('Are you sure to Apprroved?')"  href="{{action('Product\ProductController@accept', ['id' => $row->productID])}}">Pending</a>
                            ...
                            <td class="text-right"><a href="{{action('Product\ProductController@del', ['id' => $row->productID])}}" onclick="return confirm('Are you sure to Delete?')" class="close" aria-label="Close"><span aria-hidden="true">&times;</span></a></td>
                        </tr>
                        @endforeach
                    </tbody>
                </table>
